...
from superadmin.api.views import LoginViewSet,SuperAdminRegisterView,GetCustomerView,CustomerTripDetailsView,AdminListView,TrackerDeviceGeneric,\
    ...
    CreateCouponCodeAPIView, AssignCoupon, ListAllAvailableCouponsToApply, CustomerByNoOfOrders,AdminSubscriptionDetails, BulkAddTracker,AdminPaymentDetailsView,SuperadminCreateAdminViewSet,\
    AdminUpdateAPI,VendorDetailsView
...
urlpatterns=[
    ...
    # superadmin crud
    path('superadmin_create_admin/',SuperadminCreateAdminViewSet.as_view({'post':'create'})),
    ...
    path('admin_detials/',VendorDetailsView.as_view({'get':'list'}))
